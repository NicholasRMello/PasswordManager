        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('credenciais.update', $credencial) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   id="nome_servico" 
                                   name="nome_servico" 
                                   value="{{ old('nome_servico', $credencial->nome_servico) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   id="nome_usuario" 
                                   name="nome_usuario" 
                                   value="{{ old('nome_usuario', $credencial->nome_usuario) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex space-x-2">
                                <input type="password" 
                                       id="senha" 
                                       name="senha" 
                                       value="{{ old('senha', $credencial->getSenha()) }}"
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                A senha atual está preenchida. Você pode alterá-la ou gerar uma nova.
                            </p>
                        </div>
                        ...
                        <div class="mb-6 p-4 bg-blue-50 rounded-lg">
                            <h3 class="text-sm font-medium text-gray-700 mb-2">Informações da Credencial</h3>
                            <div class="text-sm text-gray-600">
                                <p><strong>Criada em:</strong> {{ $credencial->created_at->format('d/m/Y H:i') }}</p>
                                @if($credencial->updated_at != $credencial->created_at)
                                    <p><strong>Última atualização:</strong> {{ $credencial->updated_at->format('d/m/Y H:i') }}</p>
                                @endif
                            </div>
                        </div>
